...
def main(
    ...
    # 3.3 init fmri model
    pretrained_path = os.path.join(OUTPUT_PATH, pretrained_project, pretrained_name, "last-run", "checkpoints", "last")
    fmri_model = fMRIPerceptionModel.from_pretrained(pretrained_path)
    if precision is not None:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config_path', type=str, default=os.path.join(CONFIGS_PATH, "finetune_perception_model.yaml"))

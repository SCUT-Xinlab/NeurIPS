...
def main(
    ...
    fmri_model = fMRISemanticModel.from_pretrained(pretrained_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config_path', type=str, default=os.path.join(CONFIGS_PATH, "finetune_semantic_model.yaml"))
